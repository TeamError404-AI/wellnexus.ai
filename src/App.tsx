...
function App() {
  const handleAskAI = () => {
    window.location.href = 'teal-dieffenbachia-6d1e7e.netlify.app';
  };
  return (
        ...
        <div className="flex items-center">
          <div className="w-1/2">
            ...
            <div className="flex space-x-5">
              <button 
                onClick= {handleAskAI}
                className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg border border-gray-200 hover:shadow-xl group transition-all duration-300 flex items-center">
                Ask AI
